...
# ===================================
SET (DARKNET_ONNX_DEFAULT_DISABLED_ON_WINDOWS OFF)
IF (NOT DEFINED DARKNET_TRY_ONNX)
	IF (WIN32)
		SET (DARKNET_TRY_ONNX False)
		SET (DARKNET_ONNX_DEFAULT_DISABLED_ON_WINDOWS ON)
	ELSE ()
...
IF (DARKNET_TRY_ONNX)
	...
	ENDIF ()
ELSE ()
	IF (WIN32 AND DARKNET_ONNX_DEFAULT_DISABLED_ON_WINDOWS)
		MESSAGE (STATUS "Windows builds disable ONNX export by default until the protobuf/CUDA isolation work lands. Run cmake with '-DDARKNET_TRY_ONNX=True' to opt in.")
	ELSE ()
